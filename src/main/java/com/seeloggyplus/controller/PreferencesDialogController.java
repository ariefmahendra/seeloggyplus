...
public class PreferencesDialogController {
    ...
    @FXML private Spinner<Integer> appFontSizeSpinner;
    @FXML private TextField appFontFamilyField;
    @FXML private Spinner<Integer> mainWindowSizeSpinner;
    @FXML private ComboBox<String> mainDefaultLogLevelComboBox;
    @FXML private CheckBox mainAutoRefreshCheckBox;
    @FXML private CheckBox mainAutoPrettifyJsonCheckBox;
    @FXML private CheckBox mainAutoPrettifyXmlCheckBox;
    @FXML private TextField ufmDefaultPathField;
    @FXML private Button ufmBrowsePathButton;
    @FXML private CheckBox ufmShowHiddenFilesCheckBox;
    @FXML private Spinner<Integer> lpLineLimitSpinner;
    @FXML private Spinner<Integer> sshThreadsSpinner;
    ...
    private void setupSpinners() {
        ...
        mainWindowSizeSpinner.setValueFactory(new SpinnerValueFactory.IntegerSpinnerValueFactory(100, 50000, 5000, 100));
        ...
        sshThreadsSpinner.setValueFactory(new SpinnerValueFactory.IntegerSpinnerValueFactory(1, availableProcessors, Math.min(4, availableProcessors)));
    ...
    private void loadPreferences() {
        ...
        appFontFamilyField.setText(getPreference("app_font_family", "Consolas"));
        ...
        mainAutoPrettifyJsonCheckBox.setSelected(Boolean.parseBoolean(getPreference("main_auto_prettify_json", "false")));
    ...
    private void handleSave() {
        ...
        savePreference("app_font_family", appFontFamilyField.getText());
